        ...
        >
            ...
            <div className="relative z-10 w-full max-w-[1800px] flex flex-col items-center pointer-events-auto">
                ...
                >
                    ...
                    >
                        <span className="inline-flex items-center gap-4 px-[120px] py-4 rounded-full bg-cyan-900/20 border border-cyan-500/30 text-cyan-300 font-coding backdrop-blur-sm shadow-[0_0_15px_rgba(34,211,238,0.2)]">
                    ...
                    <div className="max-w-4xl mx-auto">
                        <p className="text-lg md:text-2xl font-medium leading-relaxed text-cyan-100 drop-shadow-lg font-coding text-center tracking-wide">
                ...
                >
                    ...
                    />
                    <NavCard
                        to="https://www.facebook.com/share/16qAFmRAu7/"
...
const NavCard = ({
    ...
    >
        ...
        {to.startsWith("http") ? (
            <a href={to} target="_blank" rel="noopener noreferrer" className="block h-full w-full no-underline hover:no-underline">
                <div
